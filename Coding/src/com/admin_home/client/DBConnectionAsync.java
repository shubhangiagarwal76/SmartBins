...
public interface DBConnectionAsync {
    ...
    public void insertInfo(String f_name, String l_name, long mobile_no, long aadhar, Date DOB, String email, String gender,  long sid, String location, AsyncCallback<Driver> callback5);
